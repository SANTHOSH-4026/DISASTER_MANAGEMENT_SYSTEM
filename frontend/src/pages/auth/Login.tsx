    ...
    >
      ...
      <div className="relative bg-[#0F172A]/80 backdrop-blur-2xl p-8 sm:p-10 rounded-[2rem] border border-slate-700/50 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
        ...
        <div className="mb-10 text-center lg:text-left">
          <h2 className="text-3xl font-bold text-white mb-3 tracking-tight">Secure Login</h2>
          <p className="text-slate-400 font-light">Enter your credentials to access the command center.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center ml-1">
              ...
              <Link to="/forgot-password" className="text-xs text-cyan-400 hover:text-cyan-300 transition-colors duration-300 hover:underline underline-offset-4">
                Forgot password?
              </Link>
            </div>
            <div className="relative group">
        ...
        <div className="mt-10 text-center">
          <p className="text-slate-500 text-sm">
            Not registered?{' '}
            <Link to="/signup" className="text-cyan-400 hover:text-cyan-300 font-medium transition-colors hover:underline underline-offset-4">
